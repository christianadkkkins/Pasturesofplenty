...
- `reproduce.py`: cross-platform Python runner for the cardiac cohort build, finalized cardiac HMM, finalized solar HMM, and Figure 2 solar plot reproduction.
...
5. Or run `python results/reproduce.py all` to execute the full sequence.
